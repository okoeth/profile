...
// auch Nicht-Techniker die wesentlichen Informationen aus einem übersichtlich geschriebenen
// Stück Quelltext ziehen können.
			...
			QandAs: []QandA{
				{Q: "Wie schaffe ich mein hohes Arbeitspensum?",
					A: "Zum einen steht auch bei mir der Input in Korrelation zum Output, d.h. lange Arbeitstage. " +
						...
						"Daneben sind ein paar Grundtugenden wie Zero Inbox extrem hilfreich."},
